...
Se volvió a correr la simulación, pero, aunque llegó a un número mas alto, no terminó de ejecutarse ya que el procesador dejo de funcionar en los mismos `5885795 ns`.
